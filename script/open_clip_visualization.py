...
def main(
    ...
    out_dir: str = "openclip_visualization", # output directory
    ...
    # text features 
    text_features = activation['text_features'][:, :first_k_tokens] 
    text_features = model.ln_final(text_features) @ model.text_projection
    ...
    for i in trange(first_k_tokens):
